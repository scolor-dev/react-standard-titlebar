...
(() => {
  ...
  // node_modules/@storybook/addon-onboarding/dist/Onboarding-XGKXPXUL.js
  var Onboarding_XGKXPXUL_exports = {};
  __export(Onboarding_XGKXPXUL_exports, {
    default: () => Onboarding
  });
  function y(y2, z2 = {}) {
...
`, Tooltip = ({ index, size, step, closeProps, primaryProps, tooltipProps }) => (useEffect(() => {
  ...
  // node_modules/@storybook/addon-onboarding/dist/manager.js
  var Onboarding2 = lazy(() => Promise.resolve().then(() => (init_Onboarding_XGKXPXUL(), Onboarding_XGKXPXUL_exports)));
